...
public class WalletTest {
    ...
    private IScan creditCard;
    private IScan debitCard;
    private IScan loyaltyCard;

    @Before()
    public void before(){
        wallet = new Wallet("Isa's Wallet");
        IScan creditCard = new CreditCard("1111222233334444", "12/23", 234);
        IScan debitCard = new DebitCard("1111222233334444", 909090, 12345678, "12/23", 234);
        IScan loyaltyCard = new LoyaltyCard("123456787890", "Harrid's Stores");
